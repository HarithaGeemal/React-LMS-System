    ...
    return (
        <div className="flex flex-col items-center gap-4 pt-10 pd-24 px-8 md:px-0">
            ...
            <div className="flex items-center font-medium gap-6 mt-4">
                <Link to={"/course-list"} onClick={() => window.scrollTo(0, 0)} className="px-10 py-3 rounded-md text-white bg-blue-600 hover:bg-blue-700 cursor-pointer">Start Learning</Link>
